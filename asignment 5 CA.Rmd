...
### 1) % in poverty and 2) median income by those two classification schemes.  
### 
### Use the appropriate test based on the variable measurment.
##########################################################################################################
```
